...
- **Описание:** Торговля на 5-минутных свечах с 6 индикаторами (TP: 3%, SL: 1%)
- **Таймфрейм:** 5m
...
- ✅ Изменены опции в select: Консервативный (5м свечи, 6 индикаторов, 10-20x плечо)
...
- ✅ **Веб-интерфейс:** Использует таймфрейм текущего режима (1m, 5m)
...
**🛡️ Консервативный режим:**
- ✅ **Веб-интерфейс:** 5m свечи, 6 индикаторов
- ✅ **Реальная торговля:** 5m свечи, 6 индикаторов
- ✅ **Таймфрейм:** "5m" → API: "5"
...
Сигналы подтверждаются только если совпадают на нескольких таймфреймах (например, 5m и 1h).
...
Перед открытием позиции проверять, совпадает ли сигнал на двух таймфреймах (например, 5m и 1h).
...
Основной сигнал (например, по RSI или Supertrend) совпадает на 5m и 1h.
